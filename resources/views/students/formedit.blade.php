...
<div class="card">
    ...
    <div class="card-body">
        ...
        @endif --}}
        <form method="POST" action="{{url('mahasiswa_alyzar/'.$txtid)}}">
            @csrf
            @method('PUT')
            <div class="row mb-3">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-4">
                  <textarea class="form-control @error('txtaddress') is-invalid @enderror" cols='30' rows='10' id="txtaddress" name="txtaddress">{{$txtaddress}}</textarea>
                </div>
            </div>
            <div class="row mb-3">
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-4">
                <input type="text" class="form-control form-control-sm @error('txtprodi') is-invalid @enderror" id="txtprodi" name="txtprodi" value="{{$txtprodi}}">
              </div>
            </div>
            <div class="row mb-3">
              <label for="txtagama" class="col-sm-2 col-form-label">Agama</label>
              <div class="col-sm-4">
                <input type="text" class="form-control form-control-sm @error('txtagama') is-invalid @enderror" id="txtagama" name="txtagama" value="{{$txtagama}}">
              </div>
            </div>
            <div class="row mb-3">
              <label for="txtnik" class="col-sm-2 col-form-label">NIK</label>
              <div class="col-sm-4">
                <input type="text" class="form-control form-control-sm @error('txtnik') is-invalid @enderror" id="txtnik" name="txtnik" value="{{$txtnik}}">
              </div>
            </div>
            <div class="row mb-3">
