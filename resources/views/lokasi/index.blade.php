...
<div class="mt-16 mx-10">
  <div class="flex justify-between items-start">
    <h1 class="text-white font-bold text-3xl mb-5">Data Lokasi</h1>
    <div class="flex gap-3 items-center">
      <div class="w-10 h-10 bg-[#1e6261] hover:bg-[#184D4C] ease-in-out transition duration-150 text-center rounded-full">
        <a href="{{ route('lokasi.create') }}" class="text-4xl no-underline text-white">+</a>
      </div>
          ...
          <tr>
            ...
            <td id="hapus-edit" class="text-white">
                <form action="{{ route('lokasi.destroy',$row->kode_lokasi) }}" method="POST">
                    ...
                    <a href="{{ route('lokasi.edit',$row->kode_lokasi) }}"><i class='bx bx-edit text-2xl text-white hover:bg-slate-700 bg-slate-600 p-1 rounded'></i></a>
