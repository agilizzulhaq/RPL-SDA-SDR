...
<div class="mt-16 mx-10">
  <h1 class="text-3xl text-black font-bold mb-5">Tambah Data Master Alat</h1>
  ...
  <div class="w-full bg-white rounded-xl text-sm text-black-md p-3 border-2 border-green-200">
    <form action="{{ route('nama_alat.store') }}" method="POST" enctype="multipart/form-data">
      ...
      <div class="mb-3 flex justify-between">
        ...
        <input type="number" name="kode_nama_alat" class="rounded text-sm py-1 px-2 text-black w-[700px]  border-1 border-black" id="exampleInputEmail">
      </div>
      <div class="mb-3 flex justify-between">
        <label for="nama_alat" class="form-label text-black">Nama Alat</label>
        <input type="text" name="nama_alat" class="rounded text-sm py-1 px-2 text-black w-[700px]  border-1 border-black" id="exampleInputEmail">
      </div>
      <div class="mb-3 flex justify-between">
        <label for="stok" class="form-label text-black">Stok</label>
        <input type="text" name="stok" class="rounded text-sm py-1 px-2 text-black w-[700px]  border-1 border-black" id="exampleInputEmail">
      </div>
      <div class="mb-3 flex justify-between">
        <label for="limit" class="form-label text-black">Limit</label>
        <input type="text" name="limit" class="rounded text-sm py-1 px-2 text-black w-[700px]  border-1 border-black" id="exampleInputEmail">
      </div>
      <div class="mb-3 flex justify-between">
        <label for="satuan" class="form-label text-black">Satuan</label>
