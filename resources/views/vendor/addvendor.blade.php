...
@endsection
@section('isi')
    <h1 class="text-center mb-4">Tambah Data Vendor</h1>
      <div class="container">
                ...
                <form action="/insertvendor" method="POST" enctype="multipart/form-data">
                  @csrf
                    <div class="mb-3">
                      ...
                      <input type="number" name="id_vendor" class="form-control" id="id_vendor">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="email" name="email_vendor" class="form-control" id="email_vendor">
                    </div>
                    <div class="mb-3">
