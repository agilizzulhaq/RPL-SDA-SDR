...
<a id="menu" href="/sdr" tabindex="0" class="no-underline cursor-pointer text-black hover:text-black bg-[#FFFFFF] flex pl-[17px]  hover:bg-[#FFFFFF]">
...
<a id="menu" href="/" tabindex="0" class="cursor-pointer text-black hover:text-black no-underline bg-[#D9D9D9] flex items-center pl-10 hover:bg-[#FFFFFF]">
    <span class="material-icons h-23 mt-2 " style="font-size: 25px;">chevron_right</span>
    <p class="text-lg font-bold mt-3 ml-3">Peminjaman Ruangan</p>
</a>
<a id="menu" href="/" tabindex="0" class="cursor-pointer text-black hover:text-black no-underline bg-[#D9D9D9] flex items-center pl-10 hover:bg-[#FFFFFF]">
    <span class="material-icons h-23 mt-2 " style="font-size: 25px;">chevron_right</span>
    <p class="text-lg font-bold mt-3 ml-3">Perawatan Ruangan</p>
</a>
